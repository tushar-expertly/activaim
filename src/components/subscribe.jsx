      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
          ...
          <p className="max-w-4xl mt-6 text-center text-gray-500 dark:text-gray-300">
            ...
            informed about the latest developments is crucial. Activaim is
            your go-to source for timely and relevant information. Subscribe now
            to receive insightful updates and stay ahead in your field with the
              ...
              <div className="mt-4">
                <div className="flex items-start mb-5">
                  ...
                  <label htmlFor="remember" className="ms-2 text-sm  ">
                    I agree to receive information about Activaim.com
                    training
                  </label>
                </div>
              </div>
