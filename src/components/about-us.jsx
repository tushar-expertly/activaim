          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-gray-600 text-lg">
                At Activaim, we believe in the transformative power of
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  Established in 2024,Activaim has quickly become a trusted
                  leader in online education. With a team of dedicated
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  At Activaim, excellence is not just a goal; it's our standard.
                  We are continuously striving to improve and innovate,
                  leveraging the latest technologies and methodologies to
                  deliver the highest quality online training solutions.
                </p>
              </div>
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  ...
                  towards achieving your goals with Activaim.
                </p>
              </div>
            </div>
          </div>
